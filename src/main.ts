...
function footer() { return `<footer><p>One weekly meal board for a shared kitchen device.</p><p><a href="/privacy" data-route>Privacy</a> · <a href="/terms" data-route>Terms</a> · Built by Param Factory · v1.0.0</p></footer>`; }
...
function renderLanding() {
  ...
  app.innerHTML = `${header()}<main id="main" tabindex="-1">
    ...
    <section class="privacy-note" aria-labelledby="privacy-title"><h2 id="privacy-title">What this does not do</h2><p>It does not store recipes, order groceries, score nutrition, or check allergens. It shows one weekly meal board on this device.</p><a href="/privacy" data-route>Read the privacy details</a></section>
    ${paidSection()}
