...
Landing sentences were checked against the 22-word cap.

| Sentence | Words | Result |
| --- | ---: | --- |
| Plan meals by person, not guesswork | 6 | pass |
| For households with different meals, so everyone can see what is theirs and what they share. | 16 | pass |
| See a filled week. | 4 | pass |
| Nothing is saved. | 4 | pass |
| Works offline after setup | 4 | pass |
| Saved only on this device | 5 | pass |
| One-time purchase planned | 3 | pass |
...
| --- | --- |
| household member row | lane |
| scheduled food item | meal |
